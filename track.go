...
type SimpleTrack struct {
	Artists []SimpleArtist `json:"artists" bson:"artists"`
...
type FullTrack struct {
	...
	Album SimpleAlbum `json:"album" bson:"album"`
...
type PlaylistTrack struct {
	...
	AddedBy User `json:"added_by" bson:"added_by"`
	// Whether this track is a local file or not.
	IsLocal bool `json:"is_local" bson:"is_local"`
	// Information about the track.
	Track FullTrack `json:"track" bson:"track"`
}
...
type SavedTrack struct {
	...
	// a time.Time value.
	AddedAt   string `json:"added_at" bson:"added_at"`
	FullTrack `json:"track" bson:"track"`
}
